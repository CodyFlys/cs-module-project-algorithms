...
def eating_cookies(n, memory=None):
    ...
    # the memory of cookies is 0
        ...
        # we use recursion and call eating_cookies passing in cookies(n - x) and (memory)
        memory[cookies] = eating_cookies(cookies - 1, memory) + eating_cookies(cookies - 2, memory) + eating_cookies(cookies - 3, memory)
